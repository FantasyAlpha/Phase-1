...
{
	Cinder::Memory::DoubleLinkedPool Pool;
	Cinder::Memory::DoubleLinkedPool CollidedNamesPool;
...
{
	Cinder::Memory::DoubleLinkedPool StaticsPool;
	Cinder::Memory::DoubleLinkedPool MovablesPool;
