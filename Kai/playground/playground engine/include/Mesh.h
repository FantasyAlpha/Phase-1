...
////
Mesh CreateSprite(vec3 pos, vec2 size, Color color, bool withNormals = true);

Mesh CreateCube(vec3 pos, vec3 size, Color color, bool withNormals = true);
...
void AddSprite(MeshBatch *batch, vec3 pos, vec2 size, Color color, uint32 textureID, AnimationClip *clip = 0, bool debug = false, bool withNormals = true);
