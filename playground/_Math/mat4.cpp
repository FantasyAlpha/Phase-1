...
mat4 mat4::Translation(vec3f& amount)
{
	mat4 result;
...
mat4 mat4::Rotation(vec3f &angle)
{
	mat4 rotX;
	mat4 rotY;
	mat4 rotZ;
...
vec3f operator*(mat4 &right, vec3f &left)
{
...
mat4 mat4::LookAtMatrix(vec3f &target, vec3f &up)
{
	vec3f u, v, n;
...
mat4 mat4::FPSMatrix(vec3f &eye, float pitch, float yaw)
{
	return mat4();
}
